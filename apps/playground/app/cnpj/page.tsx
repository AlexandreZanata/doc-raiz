...
export default function CnpjPlaygroundPage() {
  ...
  return (
    <main style={{ maxWidth: 720, margin: '0 auto', padding: '2rem 1.5rem' }}>
      ...
      <h1 style={{ fontSize: '1.75rem', margin: '1rem 0 0.5rem' }}>CNPJ Validator</h1>
      <p style={{ color: '#9aa5bd', marginBottom: '1.5rem' }}>
        Numeric + alphanumeric · RFB modulo 11 (Q14)
      </p>
      ...
      <p style={{ marginTop: '1.5rem', fontSize: '0.9rem' }}>
        Official source:{' '}
        <a href={CNPJ_OFFICIAL_SOURCE_URL} target="_blank" rel="noreferrer" style={{ color: '#7aa2ff' }}>
          RFB CNPJ alfanumérico (PDF)
        </a>
      </p>
