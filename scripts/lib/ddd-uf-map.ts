/**
 * Anatel national area code (DDD) to primary UF mapping.
...
export const DDD_TO_UF: Readonly<Record<string, string>> = {
...
export const UF_TO_REGIAO: Readonly<Record<string, string>> = {
