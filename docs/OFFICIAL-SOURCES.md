...
| **RG (Registro Geral)** | Per-state SSP/IGP | Full table: [§ RG](#rg--reference-index) | **UF required** — no federal algorithm. **19/27 UFs:** SP, RJ, MG, PR, RS, SC, BA, AC, AL, AM, AP, DF, ES, GO, MA, MS, MT, PA, PB. SP/RJ/MG: Ghiorzi DV tables; PR/RS/BA/AC/AL/AM/AP/DF/ES/GO/MA/MS/MT/PA/PB: format-only; SC: format-only + mask. Vectors: `rg.{sp,rj,mg,pr,rs,sc,ba,ac,al,am,ap,df,es,go,ma,ms,mt,pa,pb}.official.json`. |
...
| **CE** | ⏳ Community | Research required (variable legacy lengths) | [PCivil CE](https://www.policiacivil.ce.gov.br/) | — |
